...
from .tasks import task, proposal_task, prediction_statement_task, prediction_betting_task
...
def savePoll(sender, instance, *args, **kwargs):
    ...
    prediction_betting_task.apply_async(kwargs=dict(poll_id=instance.id, user_id=instance.created_by.id, group_id=instance.group_id), eta=instance.prediction_bet_end_date)
